...
## v13
- แก้การส่ง POST จากมือถือไป Google Apps Script ด้วย no-cors
- ตรวจสอบหลังบันทึกว่ารายการเข้า Google Sheet จริง
- ลองส่งซ้ำอัตโนมัติสูงสุด 3 ครั้ง

## แก้ไขจากไฟล์ปัจจุบัน (2026-06-27)
- แก้ JavaScript หยุดทำงานจากการประกาศ `SHARED_DB_URL` ซ้ำ 2 ครั้ง
- ปัญหานี้ทำให้ปุ่มเข้าสู่ระบบกดไม่ได้ และคำสั่งซิงก์ข้อมูลไป Google Apps Script ไม่ทำงาน
